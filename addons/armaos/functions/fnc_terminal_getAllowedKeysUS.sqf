// File: fnc_terminal_getAllowedKeysUS.sqf
/*
 * Author: Root, Wasserstoff, y0014984
 * Description: Returns the allowed keyboard key mappings for US English (US) layout.
 *
 * Arguments:
 * None
 *
 ...
 *
 * Example:
 * [TODO] call AE3_armaos_fnc_terminal_getAllowedKeysUS;
 *
 * Public: No
 */
...
[
	...
	[format ["%1-%2-%3-%4", DIK_SEMICOLON, false, false, false], ";"],
