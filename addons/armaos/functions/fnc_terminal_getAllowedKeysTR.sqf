// File: fnc_terminal_getAllowedKeysTR.sqf
/*
 * Author: Root
 * Description: Returns the allowed keyboard key mappings for Turkish (TR) layout.
 *
 * Arguments:
 * None
 *
 ...
 *
 * Example:
 * [TODO] call AE3_armaos_fnc_terminal_getAllowedKeysTR;
 *
 * Public: No
 */
...
[
	...
	[format ["%1-%2-%3-%4", DIK_A, false, false, true], "æ"],
	...
	[format ["%1-%2-%3-%4", DIK_I, false, false, false], "ı"],
	[format ["%1-%2-%3-%4", DIK_I, true, false, false], "İ"],
	...
	[format ["%1-%2-%3-%4", DIK_S, false, false, true], "ß"],
	...
	[format ["%1-%2-%3-%4", DIK_Y, false, false, false], "y"],
	[format ["%1-%2-%3-%4", DIK_Y, true, false, false], "Y"],
	[format ["%1-%2-%3-%4", DIK_Z, false, false, false], "z"],
	...
	[format ["%1-%2-%3-%4", DIK_SEMICOLON, false, false, false], "ş"],
	[format ["%1-%2-%3-%4", DIK_SEMICOLON, true, false, false], "Ş"],
	[format ["%1-%2-%3-%4", DIK_LBRACKET, false, false, false], "ğ"],
	[format ["%1-%2-%3-%4", DIK_LBRACKET, true, false, false], "Ğ"],
	[format ["%1-%2-%3-%4", DIK_RBRACKET, false, false, false], "ü"],
	[format ["%1-%2-%3-%4", DIK_RBRACKET, true, false, false], "Ü"],
	[format ["%1-%2-%3-%4", DIK_RBRACKET, false, false, true], "~"],
	[format ["%1-%2-%3-%4", DIK_APOSTROPHE, false, false, false], "i"],
	[format ["%1-%2-%3-%4", DIK_APOSTROPHE, true, false, false], "İ"],
	// Other symbols
	...
	[format ["%1-%2-%3-%4", DIK_EQUALS, true, false, false], "_"],
	[format ["%1-%2-%3-%4", DIK_COMMA, false, false, false], "ö"],
	[format ["%1-%2-%3-%4", DIK_COMMA, true, false, false], "Ö"],
	[format ["%1-%2-%3-%4", DIK_PERIOD, false, false, false], "ç"],
	[format ["%1-%2-%3-%4", DIK_PERIOD, true, false, false], "Ç"],
	...
	[format ["%1-%2-%3-%4", DIK_GRAVE, true, false, false], "é"],
	[format ["%1-%2-%3-%4", DIK_GRAVE, false, false, true], "<"],
	// Numpad
